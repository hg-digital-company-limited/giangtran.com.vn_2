                    ...
                    <div class="project-details">
                        ...
                        @if (Auth::user()->contact == null)
                            <p class="f-w-500 f-light text-danger">Quý Khách
                                Chưa Cập
                                Nhật Thông Tin Liên Hệ, Thêm Thông Tin <a href="/profile" class="text-primary">Tại
                                    Đây</a>
                            </p>
                        @endif
                        <div class="mt-3" style="display: flex;">
                            <a href="/chuyen-khoan" class="badge badge-primary text-light">Nạp
                                Tiền</a>
                            <a href="/profile" class="badge badge-secondary text-light">Lịch
                                Sử
                                Hoạt Động</a>
                            <a wire:click="logout" style="cursor: pointer;" class="badge badge-danger text-light">Đăng
                                Xuất</a>
                        </div>
                    </div>
                @else
