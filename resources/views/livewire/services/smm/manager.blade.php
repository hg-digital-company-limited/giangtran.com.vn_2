<div>
    ...
    <head>
        <title>Quản Lý Tăng Tương Tác - {{ App\Helpers\SettingsHelper::getSetting('website_name') }}</title>
        <meta name="description" content="Quản Lý Tăng Tương Tác - {{ App\Helpers\SettingsHelper::getSetting('website_name') }}">
        @livewire('inc.seo', ['keywords' => 'Quản Lý Tăng Tương Tác, ' . App\Helpers\SettingsHelper::getSetting('website_name'),
         'keywords' => 'Quản Lý Tăng Tương Tác, ' . App\Helpers\SettingsHelper::getSetting('website_name'),
