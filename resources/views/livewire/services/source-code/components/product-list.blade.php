                    ...
                    <div class="card">
                        <div class="product-box">
                            ...
                            <div class="product-details">
                                <a style="cursor: pointer;"  href="/source-code/list/{{ $item->id }}/" >
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-6 col-6">
                                        <span  onclick="window.location.href='/source-code/list/{{ $item->id }}/';"  class="badge badge-dark text-white" style="width: 100%; padding: 10px; cursor: pointer">
