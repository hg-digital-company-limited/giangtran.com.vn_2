<div>
    <head>
        ...
        <meta name="description" content="Đặt Lại Mật Khẩu - {{ App\Helpers\SettingsHelper::getSetting('website_name') }}">
        @livewire('inc.seo', ['keywords' => 'Đặt Lại Mật Khẩu, ' . App\Helpers\SettingsHelper::getSetting('website_name'),
